...
@pytest.fixture
def mock_purchase_orders() -> List[PurchaseOrder]:
    return [
        PurchaseOrder(code="750301-54-L124"),
        PurchaseOrder(code="2405-120-SE10"),
        PurchaseOrder(code="2405-121-SE10"),
        PurchaseOrder(code="2404-2281-SE10"),
        PurchaseOrder(code="2404-1231-SE11"),
    ]


def test_purchase_orders_from_tender(mock_purchase_orders: List[PurchaseOrder]) -> None:
